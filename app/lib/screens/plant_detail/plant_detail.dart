    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const CustomeCarousel(imageAssets: imageAssets),
          CustomContainer(
              child: Padding(
          ...
          CustomContainer(
            ...
            children: const [
              ...
              CharacteristicsItem(left: 'Loại cây', right: 'Cây lương thực'),
              const Divider(
                thickness: 1,
                height: 1,
              ),
          ...
          CustomContainer(
            ...
            children: [
              ListTile(
                ...
                horizontalTitleGap: -3,
                leading:
                    Icon(FontAwesomeIcons.bug, size: 20, color: Colors.black),
                title: Text('Sâu bệnh',
                    style:
                        TextStyle(fontSize: 18, fontWeight: FontWeight.w500)),
